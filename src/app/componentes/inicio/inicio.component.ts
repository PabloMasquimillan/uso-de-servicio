...
//Funcion que activa una funcion del servicio Prueba
 activar_invocable1(){
 ...
 activar_invocableSumar(){
  let datos_servicio;
  datos_servicio = this.pruebaSrv.Sumar(3);
  console.log(datos_servicio);
 }
 activar_invocablePromedio(){
  let datos_servicio;
  datos_servicio = this.pruebaSrv.Promedio(5,2);
  if(datos_servicio <= 4){
  console.log(datos_servicio);
